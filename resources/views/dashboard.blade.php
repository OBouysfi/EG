                                    ...
                                    @foreach ($recentPayments as $payment)
                                        <div class="d-flex align-items-start border-left-line pb-3">
                                            ...
                                            <div class="ml-3 mt-2">
                                                ...
                                                <p class="font-14 mb-2 text-muted">{{ $payment->amount }} MAD payé le {{ $payment->date->format('d/m/Y') }}</p>
                                                <span class="font-weight-light font-14 text-muted">{{ $payment->date->diffForHumans() }}</span>
                                            </div>
                                        </div>
                                    @endforeach
                                @endif
