                ...
                <div class="tab-pane fade active show" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                    ...
                    <div class="row justify-content-center align-items-center mb-4">
                            ...
                            <div class="row align-items-center">
                                <div class="col-auto">
                                    <div class="avatar avatar-100 text-center rounded">
                                        <img src="assets_custom/img/logo.png" alt="" class="mw-100"
                                            id="companylogolight" />
                                    </div>
                                </div>
                                <div class="col">
                                    <div>
                                        <label for="companylogolightinput" class="form-label">Upload company logo (Light
                                            layout)</label><br>
                                        ...
                                        <button class="btn btn-theme" onclick="$(this).prev().click()"><i
                                                class="bi bi-camera"></i> Upload</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-md-6 col-lg-4">
                            <div class="form-group my-2 position-relative check-valid">
                                <div class="form-floating">
                                    <input type="text" placeholder="Company Name" value="AdminUX" required
                                        class="form-control">
                        ...
                        <div class="col-12 col-md-6 col-lg-4">
                            <div class="form-group my-2 position-relative check-valid">
                                <div class="form-floating">
                                    <input type="text" placeholder="Company Tagline" value="Admin app UI" required
                                        class="form-control">
